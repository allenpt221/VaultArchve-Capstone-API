...
import { deleteId, getRandomThesis, getRepoById, getRepoViewAndDownloads, getThesis, SumbitThesis, UpdateThesis } from '../controller/repository.controller';
import { adminOnly, adminOrFaculty, facultyOnly, verifyToken } from '../middleware/middware';
...
router.post('/create', verifyToken, adminOrFaculty, upload.any(), SumbitThesis);
...
router.put('/thesis/update/:id', verifyToken, adminOrFaculty, upload.any(), UpdateThesis);
